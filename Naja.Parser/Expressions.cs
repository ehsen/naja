...
public sealed record ComplexLiteral(double Imaginary, int Line, int Column) : Expression(Line, Column);
public sealed record StringLiteral(string Value,  int Line, int Column) : Expression(Line, Column);
public sealed record BytesLiteral (string Value,  int Line, int Column) : Expression(Line, Column);
