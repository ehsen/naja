...
public sealed class NameEmitters : ExpressionEmitterBase
{
    ...
    private static FieldInfo? GetStdLibField(string moduleName)
    {
        var moduleTypeMap = new Dictionary<string, (string TypeName, string Assembly)>
        {
            ...
            ["signal"]    = ("Naja.StdLib.NajaSignal",       "Naja.StdLib"),
            ["subprocess"]= ("Naja.StdLib.NajaSubprocess",  "Naja.StdLib"),
            ["_winapi"]   = ("Naja.StdLib.NajaWinapi",       "Naja.StdLib"),
            ["mmap"]      = ("Naja.StdLib.NajaMmap",          "Naja.StdLib"),
            ["uuid"]      = ("Naja.StdLib.NajaUuid",          "Naja.StdLib"),
            ["fnmatch"]   = ("Naja.StdLib.NajaFnmatch",       "Naja.StdLib"),
            ["msvcrt"]    = ("Naja.StdLib.NajaMsvcrt",        "Naja.StdLib"),
            ...
            ["test.support"] = ("Naja.StdLib.NajaTestSupport", "Naja.StdLib"),
            ["test.support.os_helper"] = ("Naja.StdLib.NajaOsHelper",           "Naja.StdLib"),
            ["test.support.import_helper"] = ("Naja.StdLib.NajaImportHelper",   "Naja.StdLib"),
            ["test.support.script_helper"] = ("Naja.StdLib.NajaScriptHelper",   "Naja.StdLib"),
            ["test.support.socket_helper"] = ("Naja.StdLib.NajaSocketHelper",   "Naja.StdLib"),
            ["test.support.threading_helper"] = ("Naja.StdLib.NajaThreadingHelper", "Naja.StdLib"),
        };
