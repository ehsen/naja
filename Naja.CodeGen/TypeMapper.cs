...
public static class TypeMapper
{
    ...
    public static Type? ResolveExceptionType(string name) => name switch
    {
        ...
        "AttributeError" => typeof(Naja.StdLib.Core.PythonAttributeError),
        "RuntimeError" => typeof(Naja.StdLib.Core.PythonRuntimeError),
        "NotImplementedError" => typeof(Naja.StdLib.Core.PythonNotImplementedError),
        "OSError" or "IOError" => typeof(Naja.StdLib.Core.PythonOSError),
        "FileNotFoundError" => typeof(Naja.StdLib.Core.PythonOSError),
        "PermissionError" => typeof(Naja.StdLib.Core.PythonOSError),
        "OverflowError" => typeof(Naja.StdLib.Core.PythonOverflowError),
        "ZeroDivisionError" => typeof(Naja.StdLib.Core.PythonZeroDivisionError),
        ...
        "UnboundLocalError" => typeof(MissingFieldException),
